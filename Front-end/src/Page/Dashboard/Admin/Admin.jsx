            ...
            <div className="box-border flex flex-col mb-48 items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-1">
                ...
                <div className="box-border relative w-full max-w-md px-4 mt-10 mb-4  bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2" >
                    ...
                    <div style={{ backgroundColor: "#9A8C98", paddingBottom: "30px", borderRadius: "10px" }}>
                        ...
                        <table className="table-auto" style={{ width:"644px"}}>
                            ...
                            <table className="table-auto" style={{ width:"644px"}}>
                                ...
                                <tbody>
                                    <tr style={{ backgroundColor: "#C9ADA7", fontWeight: "bold", borderTop:"10px solid #9A8C98" }}>
                                        <td>{yyyy + "-" + mm + "-" + dd}</td>
                                        <td>{orders.filter(order => order.order_date === yyyy + "-" + mm + "-" + dd).length} Ventas.
                                    </td>
                                        <td>${orders.filter(order => order.order_date === yyyy + "-" + mm + "-" + dd).reduce((total, order) => total + parseInt(order.amount), 0)}.00</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div style={{ backgroundColor: "#9A8C98", paddingBottom: "30px", borderRadius: "10px" }}>
                            ...
                            <table className="table-auto"  style={{ width:"644px"}}>
                                ...
                                <tbody >
                                    ...
                                    <tr style={{ backgroundColor: "#C9ADA7", fontWeight: "bold", borderTop:"10px solid #9A8C98" }}>
                                        <td>{mm == 5 ? "Mayo" : mm == 6 ? "Junio" : mm == 7 ? "Julio": mm == 8 ? "Agosto": mm == 9 ? "Septiembre": mm == 10 ? "Octubre": mm == 11 ? "Noviembre": mm == 12 ? "Diciembre": mm == 1 ? "Enero": mm == 2 ? "Febrero": mm == 3 ? "Marzo": "Abril" }</td>
                                        <td>{orders.filter(order => order.order_date.slice(5, 7) === mm).length} Ventas.</td>
                                        <td>${orders.filter(order => order.order_date.slice(5, 7) === mm).reduce((total, order) => total + parseInt(order.amount), 0)}.00</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
