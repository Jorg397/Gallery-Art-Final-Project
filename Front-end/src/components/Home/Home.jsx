	...
	return (
		<div className={s.container}>
			...
			<Slider paints={paints}></Slider>
				<h1 style={{fontSize:"80px", fontWeight:"bolder", color:"white", letterSpacing:"5px", marginBottom:"10px", textAlign:"center"}}><label style={{fontSize:"65px", fontWeight:"bolder", color:"#9a8c98", letterSpacing:"5px"}}>.</label>...</h1>
